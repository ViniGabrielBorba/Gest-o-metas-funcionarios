    ...
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Metas Mensais</h1>
            <p className="text-gray-600">Defina e acompanhe as metas da loja</p>
          </div>
          <button
        ...
        {metas.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-xl text-gray-600">Nenhuma meta cadastrada</p>
            <button
              onClick={() => handleOpenModal()}
